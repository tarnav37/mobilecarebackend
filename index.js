...
**Mobile Care abides by all local laws and city ordinances within the state and city limits of location. Mobile Care does not tolerate dishonesty and stolen devices, and forgery of any customer.**`, { align: 'left', lineGap: 10 }).moveDown();
    ...
    app.post('/downloadselling', async (req, res) => {
        try {
          ...
          doc.fontSize(12);
           ...
           NOTE: Mobile Care abides by all local laws and city ordinances within the state and city limits of location. Mobile Care does not tolerate dishonesty and stolen devices, and forgery of any such customer.`,{ align: 'left', lineGap: 10 }).moveDown();
    ...
    app.post('/downloadrepair', async (req, res) => {
        try {
            ...
            All specifications on the contract are subject to the following terms and conditions. You agree to be bound to these terms when you sign below. These are the Terms and Conditions which you, the customer, agree to and are applicable to the repair of your device by Mobile Care:
             ...
             ➛ Repairs done by Mobile Care will void manufacture warranty, but any repairs done by us will be backed by our Warranty Policy! (We are only affiliated with Akko Insurance) 
             ➛ Any and all parts parts replaced on Apple Device are not genuine Apple Parts, but all parts are premium apple parts and will not affect the functionality of device, UNLESS part is related to functioning of Face ID.
             ➛ All Android screens are genuine Android Displays, but all small parts are not genuine android parts, but all parts are premium android parts and will not affect the functionality of device.
   ...
   NOTE: 
    Mobile Care abides by all local laws and city ordinances within the state and city limits of location. Mobile Care does not tolerate dishonesty and stolen devices, and forgery of any such customer.`,{ align: 'left', lineGap: 10 }).moveDown();
